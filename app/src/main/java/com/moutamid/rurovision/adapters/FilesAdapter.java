...
public class FilesAdapter extends RecyclerView.Adapter<ItemViewHolder> {
    ...
    public FilesAdapter(List<StatusModel> imagesList) {
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder holder, int position) {
        ...
        holder.save.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.e_delete));
        ...
        holder.imageView.setOnClickListener(v -> {
            ...
            if (status.isVideo()) {
                ...
                View view = inflater1.inflate(R.layout.row_image_full_screen, null);
                alertD.setView(view);
