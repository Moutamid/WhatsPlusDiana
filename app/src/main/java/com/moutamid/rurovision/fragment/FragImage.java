...
import com.moutamid.rurovision.adapters.RepeaterImage;
import com.moutamid.rurovision.databinding.FragImagesBinding;
        ...
        new Thread(() -> {
            ...
            if (statusFiles != null && statusFiles.length > 0) {
                ...
                mainHandler.post(() -> {
                    ...
                    imageAdapter = new RepeaterImage(imagesList, binding.imageContainer);
