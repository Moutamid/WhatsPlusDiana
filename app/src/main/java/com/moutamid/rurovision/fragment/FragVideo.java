...
import com.moutamid.rurovision.adapters.RepeaterVideo;
import com.moutamid.rurovision.databinding.FragVideosBinding;
    ...
    private void executeNew() {
        Executors.newSingleThreadExecutor().execute(() -> {
            ...
            mainHandler.post(() -> {
                ...
                videoAdapter = new RepeaterVideo(videoList, binding.videosContainer);
